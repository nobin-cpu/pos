...
class CheckoutProductEditBottomSheet extends StatefulWidget {
  final int? id;
  const CheckoutProductEditBottomSheet({super.key, this.id});

  @override
  State<CheckoutProductEditBottomSheet> createState() => _CheckoutProductEditBottomSheetState();
}

class _CheckoutProductEditBottomSheetState extends State<CheckoutProductEditBottomSheet> {
  @override
