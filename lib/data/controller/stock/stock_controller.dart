...
import 'package:flutter_prime/view/screens/stock/widgets/update_stock_by_product_bottom_sheet.dart';
...
class StockController extends GetxController {
  ...
  TextEditingController selectedroductNamecontroller = TextEditingController();
  ...
  showupdateStockByProductBottomSheet(BuildContext context, String selectedProductname) {
    selectedroductNamecontroller.text = selectedProductname.toString();
    stockcontroller.clear();
    productNamecontroller.clear();
    CustomBottomSheet(
        child: UpdateStockByProductBottomSheet(
